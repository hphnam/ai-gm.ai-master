...
| **Six-chapter position, 2026-08-09** | **Five chapters measured: Ch 2 4,938 · Ch 3 5,526 · Ch 4 7,712 · Ch 5 4,870 · Ch 6 2,328 = 25,374**, plus abstract 299. **The Introduction is the only unmeasured chapter** and is budgeted 1,400, so the projection is **~27,100 against HC1's 20,000**. The reallocation ruling still waits on six real floors and is **8C-6's precondition, not its own task** |
