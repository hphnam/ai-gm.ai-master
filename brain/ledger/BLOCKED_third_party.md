...
| **Conclusions floor — SUPERSEDES the 1,460 row above. Measured 2026-08-09 after 8C-5** | **2,325 marker words** (opener 85 · **6.1** 429 · **6.2** 959 · **6.3** 690 · **6.4** 162) against the retired 1,100 allocation. **6.3 was compressed 926 → 690** by returning its per-venue numbers to the sections that own them. **6.2 grew 307 → 959** and that is the finding, not the overrun: the four-claim version omitted **C2** (the weather and pooling pair) *and* **RQ2's reconciliation and estimand result**, both negative results, and about 180 further words are qualifiers the five-role critique added in place of over-claims — the power clause, "calibrated band", "to a thousandth", "both returned nulls", the missing population, the misdescribed selection protocol. **This is measurement replacing assertion costing words for the fifth recorded time.** Displacement recorded at `05_paper_architecture.md` §4.5, which had **no Chapter 6 row at all** before this session. *Instrument: `brain/scripts/wordcount.py chapters/conclusion.tex`* |
| **Six-chapter position, 2026-08-09** | **Five chapters measured: Ch 2 4,938 · Ch 3 5,526 · Ch 4 7,712 · Ch 5 4,870 · Ch 6 2,325 = 25,371**, plus abstract 299. **The Introduction is the only unmeasured chapter** and is budgeted 1,400, so the projection is **~27,100 against HC1's 20,000**. The reallocation ruling still waits on six real floors and is **8C-6's precondition, not its own task** |
