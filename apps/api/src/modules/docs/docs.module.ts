...
import { MemoryReconcileModule } from '../organization/memory-reconcile.module'
...
@Module({
  ...
  providers: [DocsService, ClassifierService, ChecklistExtractorService, ReconcileService],
