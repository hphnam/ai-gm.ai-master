...
// Date.now() — zero behaviour change. Under PROBE_CHAT_V2_STUB=1, stubClock()
...
import { FROZEN_STUB_NOW_MS } from '../../types/chat-v2'

export function stubClock(): number {
  return process.env.PROBE_CHAT_V2_STUB === '1' ? FROZEN_STUB_NOW_MS : Date.now()
}
